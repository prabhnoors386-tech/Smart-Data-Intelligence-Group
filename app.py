...
def initialize_mock_database() -> sqlite3.Connection:
    ...
    posts_data = [
        (1, 1, "Best practices for data cleaning", "A comprehensive guide on data cleaning techniques...", 
         (base_date + timedelta(days=2)).isoformat(), 450, 89, 12, "data-science"),
        (2, 2, "Python performance optimization", "Tips and tricks for speeding up Python code...", 
         (base_date + timedelta(days=5)).isoformat(), 520, 102, 34, "programming"),
        (3, 3, "Introduction to transformers", "Understanding transformer architecture in NLP...", 
         (base_date + timedelta(days=7)).isoformat(), 680, 156, 67, "ai-ml"),
        (4, 1, "Community guidelines update", "New moderation policies for 2024...", 
         (base_date + timedelta(days=10)).isoformat(), 290, 45, 8, "announcements"),
        (5, 5, "SQL query optimization", "Advanced techniques for efficient database queries...", 
         (base_date + timedelta(days=12)).isoformat(), 410, 78, 23, "databases"),
    ]
...
def main():
            ...
            if not success:
                ...
                if results_df.empty:
                    ...
                    with st.spinner("🧠 Generating AI insights..."):
                        insights = generate_insights(results_df, user_query, api_key)
    ...
    <p>🔐 <strong>Security Note:</strong> All queries are validated and sanitized. 
    Only SELECT operations are permitted.</p>
